...
const EnhancedTableHead = props => {
  const { onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, checkboxes, columns } = props;
...
const EnhancedTableToolbar = (props) => {
  const { title, numSelected, handleAddNew } = props;
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      <TableRow
                        ...
                        onClick={e => checkboxes && handleSelect(row.id)}
                        tabIndex={-1}
                        key={row.id}
